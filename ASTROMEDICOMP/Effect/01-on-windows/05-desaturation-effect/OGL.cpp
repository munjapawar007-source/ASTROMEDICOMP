...
GLfloat desaturationAmountUniform = 0.0f;
...
int initialize(void)
{
	...
	const GLchar *fargamentShaderSourceCode =
		...
		"void main(void)\n"
		"{\n"
		"vec4 texColor = texture(uTextureSampler,out_TexCord);\n"
		"vec3 color = texColor.rgb;\n"
		"float luminance = dot(color, vec3(0.2126, 0.7152, 0.0722));\n"
		"vec3 desaturationColor = mix(texColor.rgb, vec3(luminance), uDesaturationAmount);\n"
		"FragColor = vec4(desaturationColor, texColor.a);\n"
		"}\n";
	...
	desaturationAmountUniform = glGetUniformLocation(shaderProgramObject, "uDesaturationAmount");
...
void display(void)
{
	...
	glUniform1f(desaturationAmountUniform, 0.50);

...
function display() {
   ...
   gl.uniformMatrix4fv(projectionMatrixUniform, false, perspectiveProjectionMatrix);
    ...
    {
        // 1) send proper size 
        gl.uniform3fv(laUniform[0], myLight[0].ambient ); 
        gl.uniform3fv(ldUniform[0], myLight[0].diffuse);
        gl.uniform3fv(lsUniform[0], myLight[0].specular);
        gl.uniform4fv(lightPositionUniform[0], myLight[0].position);

        gl.uniform3fv(laUniform[1],  myLight[1].ambient);
		gl.uniform3fv(ldUniform[1],  myLight[1].diffuse);
		gl.uniform3fv(lsUniform[1],  myLight[1].specular);
		gl.uniform4fv(lightPositionUniform[1], myLight[1].position);

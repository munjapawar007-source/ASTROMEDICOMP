...
function resize()
{
   ...
   mat4.perspective(perspectiveProjectionMatrix,45.0,parseFloat(canvas.width)/parseFloat(canvas.height),0.1,100.0)
	...
	{
        orthographicProjectionMatrix = mat4.ortho(  
                                                -100.0, //left
                                                100.0, //right
                                                (-100.0 * (parseFloat(canvas.height) / parseFloat(canvas.width))), //bottom
                                                (100.0 * (parseFloat(canvas.height) / parseFloat(canvas.width))), //top
                                                -100.0, //near
                                                100.0); //far
	}
	else
	{
        orthographicProjectionMatrix = mat4.ortho(
                                            (-100.0 * (parseFloat(canvas.width) / parseFloat(canvas.height))),
                                            (100.0 * (parseFloat(canvas.width) / parseFloat(canvas.height))),
                                            -100.0,
                                            100.0,
                                            -100.0,

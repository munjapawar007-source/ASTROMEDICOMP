...
function display() 
{
    ...
    // SUN
    pushMatrix();
    mat4.rotateX(RotationMatrix, RotationMatrix, 90.0 * Radian);
    mat4.translate(translationMatrix, translationMatrix, [0.0, 0.0, -5.0]);
    mat4.multiply(currentMatrix, translationMatrix, RotationMatrix);

    mat4.scale(scaleMatrix, scaleMatrix, [1.50, 1.50, 1.50]);
    mat4.multiply(currentMatrix, currentMatrix, scaleMatrix);
    modelMatrix = currentMatrix;
    gl.uniformMatrix4fv(modelMatrixUniform, false, modelMatrix);
    gl.uniform3f(materialColorUniform, 1.0, 1.0, 0.0);
    sphere.draw(gl.LINES);
    popMatrix();

    // EARTH
    pushMatrix();
    mat4.rotateZ(RotationMatrix, RotationMatrix, year * Radian);
    mat4.multiply(currentMatrix, currentMatrix, RotationMatrix);

    mat4.translate(translationMatrix, translationMatrix, [1.50, -0.10, 0.0]);
    mat4.rotateY(RotationMatrix, RotationMatrix, 90.0 * Radian);
    mat4.multiply(currentMatrix, translationMatrix, RotationMatrix);

    mat4.rotateY(RotationMatrix, RotationMatrix, date * Radian);
    mat4.multiply(currentMatrix, currentMatrix, RotationMatrix);

    mat4.scale(scaleMatrix, scaleMatrix, [0.50, 0.50, 0.50]);
    mat4.multiply(currentMatrix, currentMatrix, scaleMatrix);
    modelMatrix = currentMatrix;
    gl.uniformMatrix4fv(modelMatrixUniform, false, modelMatrix);
    gl.uniform3f(materialColorUniform, 0.40, 0.70, 1.0);
    sphere.draw(gl.LINES);
    popMatrix();

    // MOON
    pushMatrix();
    mat4.rotateX(RotationMatrix, RotationMatrix, year * Radian);
    mat4.multiply(currentMatrix, currentMatrix, RotationMatrix);
    ...
    mat4.scale(scaleMatrix, scaleMatrix, [0.19, 0.2, 0.19]);
    mat4.multiply(currentMatrix, currentMatrix, scaleMatrix);
    modelMatrix = currentMatrix;
    gl.uniformMatrix4fv(modelMatrixUniform, false, modelMatrix);
    gl.uniform3f(materialColorUniform, 1.0, 0.9, 1.0);
    sphere.draw(gl.LINES);
    popMatrix();

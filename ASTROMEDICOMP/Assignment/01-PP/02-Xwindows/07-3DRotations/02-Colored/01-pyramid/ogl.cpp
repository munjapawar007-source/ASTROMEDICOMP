...
int Initialize(void)
{
    ...
    // Position
    glGenBuffers(1, &vbo_position_pyramid); // all arrays associate with vao_pyramid
    ...
    glGenBuffers(1, &vbo_color_pyramid); // all arrays associate with vao_pyramid
...
void display(void)
{
    ...
    rotationMatrix = vmath::rotate(angleRect_mp, 0.0f, 1.0f, 0.0f);

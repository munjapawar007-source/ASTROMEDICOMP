...
int Initialize(void)
{
    ...
    const GLfloat rectanglePosition_TexCoords[] =
        {
            1.0, 1.0,
            0.0f, 1.0f,
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(rectanglePosition_TexCoords), rectanglePosition_TexCoords, GL_DYNAMIC_DRAW);
    ...
    // loadTexture
    if (LoadGLTexture(&textureSmiley, "Smiley.bmp") == False)
    {

...
//Roatation
GLfloat angleTriangle_MP = 0.0f;
GLfloat angleRectangle_MP = 0.0f;
...
void display(void)
{
	...
	rotationMatrix = vmath::rotate(angleRectangle_MP, 0.0f, 1.0f, 0.0f);
	...
	translationMatrix = vmath::translate(-1.5f, 0.0f, -6.0f);
	rotationMatrix = vmath::rotate(angleRectangle_MP, 1.0f, 0.0f, 0.0f);
	modelViewMatrix = translationMatrix * rotationMatrix; //order is important
...
{
	//code
	angleTriangle_MP = angleTriangle_MP + 0.05f;

	if (angleTriangle_MP >= 360.0f)
	{
		angleTriangle_MP = angleTriangle_MP - 360.0f;

	}

	angleRectangle_MP = angleRectangle_MP - 0.05f;

	if (angleRectangle_MP <= 0.0f)
	{
		angleRectangle_MP = angleRectangle_MP + 360.0f;

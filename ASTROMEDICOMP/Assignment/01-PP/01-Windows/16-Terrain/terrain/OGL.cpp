...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	if (gpFile == NULL)
	{
		MessageBoxA(NULL, TEXT("Log File Creation Failed"), TEXT("Error"), MB_OK);
		exit(0);
	}
	else
	{
...
void display(void)
{
	...
	translationMatrix = vmath::translate(0.0f, -0.30f, -5.0f);
	scaleMatrix = vmath::scale(5.0f,5.0f,5.0f);
	rotationMatrix = vmath::rotate(t, 0.0f, 1.0f, 0.0f);
	rotationMatrix = rotationMatrix * vmath::rotate(90.0f, 1.0f, 0.0f, 0.0f);

      ...
      implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener 
{
   ...
   private int vbo_texcoord_of_pyramid[] = new int[1];

    private int vao_cube[] = new int[1];
   private int vbo_position_cube[] = new int[1];
   private int vbo_texcoord_of_cube[] = new int[1];
   ...
   private int initialize(GL10 gl) 
   {
     ...
     /*---------------------pyramid---------------------*/
      ...
      // TEXCOORD
      GLES32.glGenBuffers(1, vbo_texcoord_of_pyramid, 0);
      GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vbo_texcoord_of_pyramid[0]);
      ...
      // 4) fill array of rectangle_ position
         pyramidTexcoordsBuffer.put(pyramid_Texcoords);
      // 5)  set array to 0th position for repeatable use
          pyramidTexcoordsBuffer.position(0);
      GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, pyramid_Texcoords.length * 4, pyramidTexcoordsBuffer, GLES32.GL_STATIC_DRAW);
      ...
      // Position
      GLES32.glGenBuffers(1, vbo_texcoord_of_cube,0);
      GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vbo_texcoord_of_cube[0]);
      ...
      texture_stone[0] = loadGLTexture(R.raw.stone); // tujya resources madhe ja ani tyatil raw dir madil png ghe 
   ...
   private void Display() 
   {
     ...
     //transformstions
      ...
      Matrix.translateM(translationMatrix,0,-1.50f, 0.0f, -5.0f);
 ...
 /* ---------------cube--------------- */
   ...
   private void Uninitialize() 
   {
      ...
      if(vbo_texcoord_of_cube[0] > 0)
      {
         GLES32.glDeleteBuffers(1,vbo_texcoord_of_cube,0);
         vbo_texcoord_of_cube[0] = 0;
      ...
      {
         GLES32.glDeleteBuffers(1,texture_stone,0);
         texture_stone[0] = 0;
      }

      if(vbo_texcoord_of_pyramid[0] > 0)
      {
         GLES32.glDeleteBuffers(1,vbo_texcoord_of_pyramid,0);
         vbo_texcoord_of_pyramid[0] = 0;

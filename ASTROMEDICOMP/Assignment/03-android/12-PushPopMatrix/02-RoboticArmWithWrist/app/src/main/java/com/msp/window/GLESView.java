      ...
      implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener 
{
   ...
   private void Display() 
   {
      ...
      // color uniform
      GLES32.glUniform3f(materialColorUniform, 0.5f, 0.35f, 0.05f); 

      Matrix.translateM(translationMatrix, 0, -1.0f, 0.0f, -1.0f);
      ...
      pushMatrix();
      Matrix.scaleM(scaleMatrix, 0, 2.0f, 0.55f, 1.0f);
      ...
      pushMatrix();
      // ELBOW
      Matrix.translateM(translationMatrix, 0, 1.50f, 0.0f, 0.0f);
      Matrix.multiplyMM(currentMatrix, 0, currentMatrix, 0, translationMatrix, 0);
      ...
      Matrix.scaleM(scaleMatrix, 0, 2.0f, 1.5f, 1.5f);
      Matrix.multiplyMM(modelMatrix, 0, currentMatrix, 0, scaleMatrix, 0);
      GLES32.glUniformMatrix4fv(modelMatrixUniform, 1, false, modelMatrix, 0);
